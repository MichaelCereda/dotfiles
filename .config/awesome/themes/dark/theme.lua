...
theme.titlebar_close_button_normal = "~/icons/110895-line-icon-set/png/cross.png" -- theme_path.."/titlebar/close_normal.png"
theme.titlebar_close_button_focus  = "~/icons/110895-line-icon-set/png/cross.png" -- theme_path.."/titlebar/close_focus.png"
